...
/** Validates input data in EditForm of division */
public class DivisionEditFormSubmitValidator implements Validator {
	...
	public void validate(Object obj, Errors errors) {
		...
		if (!formDivision.getDivision().trim().equals("")) {
			...
			while (iter.hasNext()) {
				...
				if (div.getDivision().equals(formDivision.getDivision().trim())) {
