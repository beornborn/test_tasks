...
/** Tests DivisionAddFormSubmitValidator.class */
public class DivisionAddFormSubmitValidatorTest extends TestCase {
	DivisionAddFormSubmitValidator validator;
	...
	@Before
	public void setUp() {
		validator = new DivisionAddFormSubmitValidator();
