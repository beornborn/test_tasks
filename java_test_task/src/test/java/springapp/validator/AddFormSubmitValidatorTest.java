...
/** Tests AddFormSubmitValidator.class */
public class AddFormSubmitValidatorTest extends TestCase {
	...
	public void testValidate() throws Exception {
		AddFormSubmitValidator afsv = new AddFormSubmitValidator();
