ActiveAdmin::Dashboards.build do
  ...
  section "Recent entitys", :priority => 1 do
    table_for entity.where(:parent_entity_id=>nil).order('id desc').limit(30) do
      column(:body)   {|entity|  link_to(truncate(entity.body, :length=>180), admin_entity_path(entity))}
      column("date of creation"){|entity| entity.created_at }
    end
  end
#
